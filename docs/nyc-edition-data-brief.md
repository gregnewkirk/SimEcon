...
|---|---|---|
| **1975 fiscal crisis** | ~60,000 positions cut, mostly attrition/transfer rather than layoffs | The actual trough headcount — a widely repeated "300k→200k" framing found **no support** |
...
| **Class-size mandate** | **$702M/yr** (IBO, Dec 2025, ~6,900 teachers) vs **$1.5–1.65B** (Comptroller, >14,000 teachers) — a 2.3× spread worth surfacing in-game. Full compliance Sept 2028, phasing 20% of classrooms/yr | **ALBANY mandate, CITY cost** — the cleanest unfunded-mandate lever |
