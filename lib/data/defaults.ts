...
export const WEALTH_BRACKETS: WealthBracket[] = [
  { id: "top1", label: "Top 1%", shortLabel: "1%", color: "#ff3b30", shareOfWealth: 0.31 },
  { id: "next9", label: "Next 9%", shortLabel: "9%", color: "#ff9500", shareOfWealth: 0.27 },
  { id: "middle40", label: "Middle 40%", shortLabel: "40%", color: "#007AFF", shareOfWealth: 0.28 },
  { id: "bottom50", label: "Bottom 50%", shortLabel: "50%", color: "#86868b", shareOfWealth: 0.025 },
];
