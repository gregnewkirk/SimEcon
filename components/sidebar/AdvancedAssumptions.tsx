  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      ...
      <CollapsibleContent className="mt-3 space-y-3">
        {/* ── Macroeconomic ── */}
        <div className="text-[9px] uppercase tracking-widest text-[#86868b] pt-1">Macro</div>
        <TaxSlider
          label="GDP Growth"
        ...
        {/* ── Behavioral ── */}
        <div className="text-[9px] uppercase tracking-widest text-[#86868b] pt-1">Behavioral</div>
        <TaxSlider
        ...
        {/* ── Program Costs ── */}
        <div className="text-[9px] uppercase tracking-widest text-[#86868b] pt-1">Program Costs</div>
        <TaxSlider
          label="Cost Scenario"
          ...
          suffix="×"
        />
        <p className="text-[9px] text-[#c7c7cc] leading-tight">
