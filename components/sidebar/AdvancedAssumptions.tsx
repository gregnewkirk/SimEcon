...
export function AdvancedAssumptions({
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <CollapsibleTrigger className="flex items-center gap-1.5 text-xs uppercase tracking-wider font-semibold text-[#86868b] hover:text-[#1d1d1f] transition-colors">
        <span>{open ? "\u25BE" : "\u25B8"}</span>
      ...
      <CollapsibleContent className="mt-3 space-y-3">
        {/* ── Macroeconomic ── */}
        <div className="text-[11px] uppercase tracking-widest text-[#86868b] pt-1">Macro</div>
        <TaxSlider
          label="GDP Growth"
        ...
        {/* ── Behavioral ── */}
        <div className="text-[11px] uppercase tracking-widest text-[#86868b] pt-1">Behavioral</div>
        <TaxSlider
        ...
        {/* ── Program Costs ── */}
        <div className="text-[11px] uppercase tracking-widest text-[#86868b] pt-1">Program Costs</div>
        <TaxSlider
          label="Cost Scenario"
          ...
          suffix="×"
        />
        <p className="text-[11px] text-[#c7c7cc] leading-tight">
